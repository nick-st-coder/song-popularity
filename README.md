...
Let's imagine situation - a band/artist don't know which songs should be singles / get music video etc. Well i'll solve this problem in this repo.

Question is - "Can we estimate a song's popularity from its audio characteristics?
Let's answer together by going to notebooks section! (not finished yet)
